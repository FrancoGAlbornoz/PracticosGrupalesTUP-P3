          ...
          <aside>
            ...
            <p className='textoaside'>
              <ol>
                ...
                <li>
                  <span className="spanaside">Lenguaje de alto nivel:</span> Estos lenguajes están diseñados para ser más fáciles de leer y escribir para los humanos, utilizando una sintaxis más cercana al lenguaje natural. Ejemplos incluyen Python, Java y C#. Son más abstractos que los lenguajes de bajo nivel, lo que facilita la programación, pero a veces pueden ser menos eficientes en términos de rendimiento.
                </li>
                <li>
                  <span className="spanaside">Lenguajes compilados:</span> Estos lenguajes requieren un proceso de compilación, donde el código fuente se traduce a un lenguaje de máquina antes de ejecutarse. Ejemplos incluyen C y C++. La compilación puede mejorar el rendimiento, pero introduce un paso adicional en el desarrollo.
                </li>
                <li>
